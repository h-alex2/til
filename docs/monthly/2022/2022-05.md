...
- [ ] [“오랜 프로그래머로부터의 조언”​](https://j.mearie.org/post/6038530297/advice-from-an-old-programmer)
...
/spec 디렉토리 내의 3번부터 마지막 순번까지 테스트를 통과시킬 수 있도록 /async 디렉토리 내의 함수들을 완성시켜 주세요.
7번에 한해 Promise 사용이 가능합니다.
이번 과제 해결을 위해 sort 메소드와 setTimeout은 사용할 필요가 없습니다. 
/spec 디렉토리 내의 3번부터 마지막 순번까지 테스트를 통과시킬 수 있도록 /async 디렉토리 내의 함수들을 완성시켜 주세요.
...
13일의 금요일이군
throttle
- 유저의 인터랙션 중간중간에 인풋에 해당하는 값을 보여주되, 그 인터벌을 원하는 대로 조정하고 싶은 상황에서 사용할 수 있다.
